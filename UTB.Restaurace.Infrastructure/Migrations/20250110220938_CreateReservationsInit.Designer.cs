...
namespace UTB.Restaurace.Infrastructure.Migrations
{
    ...
    [Migration("20250110220938_CreateReservationsInit")]
    partial class CreateReservationsInit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UTB.Restaurace.Domain.Entities.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("ReservationCreationTime")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime(6)");

                    MySqlPropertyBuilderExtensions.UseMySqlComputedColumn(b.Property<DateTime>("ReservationCreationTime"));
            ...
            modelBuilder.Entity("UTB.Restaurace.Domain.Entities.ReserveMeal", b =>
                {
                    b.HasOne("UTB.Restaurace.Domain.Entities.Meal", "Meal")
                        .WithMany()
                        .HasForeignKey("MealId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UTB.Restaurace.Domain.Entities.Reservation", "Reservation")
                        .WithMany("ReserveMeals")
